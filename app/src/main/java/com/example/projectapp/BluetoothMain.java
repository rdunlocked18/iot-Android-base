...
public class BluetoothMain extends AppCompatActivity implements AdapterView.OnItemClickListener {
...
//        Send=(Button)findViewById(R.id.button11);
        ...
        lvNewDevices.setOnItemClickListener(BluetoothMain.this);
        ...
        Discover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mBluetoothAdapter.isDiscovering()){
                    ...
                    ActivityCompat.requestPermissions(BluetoothMain.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},1);
                    ActivityCompat.requestPermissions(BluetoothMain.this,new String[]{Manifest.permission.ACCESS_COARSE_LOCATION},1);
        ...
        Recieve.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent connection=new Intent(BluetoothMain.this,Connection.class);
